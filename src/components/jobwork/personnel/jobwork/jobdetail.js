...
import { FaRegFilePdf, FaTrash, FaCheckCircle } from "react-icons/fa";
import NumberFormat from "react-number-format";
import SimpleReactLightbox from "simple-react-lightbox";
import { SRLWrapper } from "simple-react-lightbox";
import SidebarWithHeader from "../../../../shared/SidebarProps";

const Personneljobinfodetail = (props) => {
  const { id } = useParams();
                        ...
                        {values.clients?.map((client, i) => {
                          return (
                            <option
                              ...
                              selected={
                                jobdetail.client_name == client.client_name
                              }
                            >
                              {client.client_name}
                            </option>
                    ...
                    <FormControl isInvalid={errors.division_name?.message}>
                      ...
                      >
                        <option
                          ...
                          selected={jobdetail.division_name}
                        >
                    ...
                    <SimpleReactLightbox>
                      <SRLWrapper>
                        <a href={`${BASE_URL}${jobdetail.photo_url}`}>
                          <Img
                            src={`${BASE_URL}/${jobdetail.photo_url}`}
                            className="photo"
                          />
                        </a>
                      </SRLWrapper>
                    ...
                    <GridItem>
                      ...
                      >
                        ...
                        <Textarea
                          type="text"
                          {...register(
                            `defect_details[${index}].recommendation`,
                            {
                              required: "cannot be empty",
                            }
                          )}
...
export default Personneljobinfodetail;
